...
toff <- list(amount=-1, rate=0.25, time=c(43, 73, 103, 133, 163, 193, 223, 253, 
                                   285, 349, 379, 409, 454, 486, 541, 570, 657, 691))
tr <- list(ton, toff)
...
mlxplore(model='hog_model.txt', parameter=p, output=out, treatment=tr)
